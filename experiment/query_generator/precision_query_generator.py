...
with open('../../log_data/2018_transaction_testing_data/user_to_items.data', 'rt') as fin:
    for line in fin:
        ...
        # try:
        #     query_list = [random.choice([item for item in item_list if item in popular_events])]
        # except IndexError:
        #     continue
